...
<body>
  ...
  <div class="container">
      <div class="seven columns headertext animated bounce">
...
<section id="testimonials">
  <div class="container">
    <div class="eight columns offset-by-two">
		<span class="action"><h2>Who's using it?</h2></span>
      <span class="action"><p>Jott.ly has around 150,000 satisfied customers sharing and collaborating with teams throughout 35 countries. Here’s what a few had to say:</p></span>
    </div>
    <div class="row">
      <div class="one-third column">
        <blockquote>
        ...
        <div class="avatar">
          <img src="images/avatar1.jpg" alt="danny" />
          <p>Danny S.</p>
        </div>
      </div>
      <div class="one-third column">
        ...
        <div class="avatar">
          <img src="images/avatar2.jpg" alt="jon" />
          <p>Jonathan M.</p>
        </div>
      </div>
      <div class="one-third column">
        ...
        <div class="avatar">
          <img src="images/avatar3.jpg" alt="chloe" />
          <p>Chloe P.</p>
        </div>
      </div>
    </div>
